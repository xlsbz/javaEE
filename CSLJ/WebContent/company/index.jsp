	...
	<div style="width: 1400px; margin: 0 auto">
		...
		<h3>
			<font color="red"><a href="index.jsp">首页</a></font> <span
				...
				onclick="location.href='CompanyS?option=query_company'">
			</span> <span style="margin-left: 200px"> <input
				style="padding: 10px; background: white; color: black;"
				type="button" value="发布招聘信"
				onclick="location.href='add_companyjob.jsp'">
			</span> <span style="margin-left: 200px"> <input
				style="padding: 10px; background: white; color: black;"
				type="button" value="查看招聘信"
				onclick="location.href='CompanyJobS?option=getAll_jobs'">
			</span> <span style="margin-left: 400px"> <input
				style="padding: 10px; background: white; color: red;" type="button"
				value="注销" onclick="location.href='CompanyS?option=logon'">
			</span>
		</h3>
		<hr size="9">
		<div
			...
			%>
			<h1>
				点击<a href="login_company.jsp">这里</a>登录
			</h1>
			<h2>
				还没账号?点击<a href="register_company.jsp">这里</a>注册
			</h2>
			<%
				}
			%>
