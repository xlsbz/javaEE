...
<div style="width: 1400px; margin: 0 auto">
	...
	<form method="post" action="StudentS" onsubmit="return enabled()">
		<h1>填写注册信息</h1>
		登录名：<input type="text" name="sname" onblur="registerAjax(this.value)"><span
			id="msg"></span><br>
		<p>
		...
		<p>
			专&nbsp;&nbsp;业：<input type="text" name="specialty"><br>
		<p>
			学&nbsp;&nbsp;历：<input type="text" name="knowledge"><br>
		<p>
			邮&nbsp;&nbsp;箱：<input type="text" name="email"><br>
		<p>
			说&nbsp;&nbsp;明：<input type="text" name="resume"><br>
		<p>
			<input type="submit" name="" value="注册"> <input type="hidden"
				name="option" value="register_student"> <input type="reset"
				value="重置">
	</form>
	<%
