...
<div class="main">
<div class="container">
		<div class="public-nav" style="margin-top:1%">您当前的位置：<a href="">会议管理</a>><a href="">录入信息</a></div>
		<div class="public-content">
			<div class="public-content-header">
				<h3 style="display: inline-block;">修改会议信息</h3>
...
<div style="margin-left:30%">
 ...
 <legend style="font-size:36px;margin-left:20%">修改会议信息</legend>
   <div><span class="titlespan">会议类型</span><input type="text" name="mType" class="formText" value="${meeting.mType}" ></div>
  <div><span class="titlespan">会议时间</span><input type="text" name="mTime" class="formText" value="${meeting.mTime}"></div>
  <div><span class="titlespan">会议地址</span><input type="text" name="mAddress" class="formText"  value="${meeting.mAddress}"></div>
  <div><span class="titlespan">会议状态</span>
  正常<input type="radio" name="mState" value="正常">
  异常<input type="radio" name="mState" value="异常">
  </div>
  <div><span class="titlespan">会议名称</span><input type="text" name="mName" class="formText"  value="${meeting.mName}" placeholder="禁止修改会议名称"></div>
  <div><span class="titlespan">会议发布人</span><input type="text" name="admId" class="formText"  value="${meeting.admId}" disabled="disabled"></div>
  <div><span class="titlespan"></span><input type="hidden" name="option" class="formText" value="updateMeetingInfo"></div>
  <div><span class="submitspan"></span><input type="submit" class="formSubmit" value="update"></div>
 </form>
 </div>
