...
<div style="margin-left:30%">
 ...
 <legend style="font-size:36px;margin-left:20%">修改会议信息</legend>
  ...
  <div><span class="titlespan">会议发布人</span><input type="text" name="admId" class="form-control formText" placeholder="禁止改动" disabled="disabled"></div>
  <div><span class="titlespan"></span><input type="hidden" name="option" class="formText" value="updateSignInInfo"></div>
  <div><span class="submitspan"></span><input type="submit" class="formSubmit" value="updateSignInInfo"></div>
 </form>
 </div>
