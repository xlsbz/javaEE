...
<body>
 ...
 apply.getApplyByID(request);//request是jsp的内置对象，由服务器生成，服务器启动new request对象
...
<div class="container">
 ...
 <form action="ApplyS" method="get">
 <legend style="font-size:30px;margin-left:20%">按赛事编号删除</legend>
  <div><span class="titlespan">赛事编号:</span><input type="text" name="applyId" class="formText" value="${admin.admID}" placeholder=${admin.admID}></div>
     <div><span class="titlespan"></span><input type="hidden" name="option" class="formText" value="deleteApplyInfo"></div>
   <div><span class="submitspan"></span><input type="submit" class="formSubmit" value="deleteApplyInfo"></div>
