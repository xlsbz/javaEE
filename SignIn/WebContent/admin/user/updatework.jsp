		...
		<div class="public-content">
			<div class="public-content-header">
				...
				<div class="public-content-right fr">
					<a href="admin/user/addWorkerInfo.jsp?suboption=nopage" style="height: 24px; width: 60px;border: 1px solid #ccc;font-size: 12px;text-align:center">新增</a>
				</div>
			</div>
...
<div style="margin-left:30%">
 ...
 <legend style="font-size:36px;margin-left:20%">修改信息</legend>
   <div><span class="titlespan">员工ID</span><input type="text" name="wiID" class="formText" value="${adminInfomation.adm_Id}" ></div>
  <div><span class="titlespan">管理员ID</span><input type="text" name="admID" class="formText" value="${adminInfomation.adm_Number}"></div>
  <div><span class="titlespan">员工姓名:</span><input type="text" name="wiName" class="formText"  value="${adminInfomation.admPsd}"></div>
  <div><span class="titlespan">员工性别:</span>
  男<input type="radio" name="wiSex" value="男">
  女<input type="radio" name="wiSex" value="女">
  </div>
  <div><span class="titlespan">员工职务</span><input type="text" name="wiGrade" class="formText"  value="${adminInfomation.admPower}"></div>
  <div><span class="titlespan">员工密码:</span><input type="text" name="wiPsd" class="formText"  value="${adminInfomation.admPhone}"></div>
  <div><span class="titlespan">员工住址:</span><input type="text" name="wiAddress" class="formText"  value="${adminInfomation.admPower}"></div>
  <div><span class="titlespan">员工电话</span><input type="text" name="wiPhone" class="formText"  value="${adminInfomation.admPhone}"></div>
   <div><span class="titlespan">出生日期</span><input type="text" name="wiBorthday" class="formText"  value="${adminInfomation.admPower}"></div>
 
 <div><span class="titlespan"></span><input type="hidden" name="option" class="formText" value="updateUserInfo"></div>
  <div><span class="submitspan"></span><input type="submit" class="formSubmit" value="updateUserInfo"></div>
 </form>
 </div>
