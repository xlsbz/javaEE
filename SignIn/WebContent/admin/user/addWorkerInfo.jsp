...
<legend style="font-size:36px;margin-left:20%">录入员工信息</legend>
 <form action="UserS" method="post"> 

  <div><span class="titlespan">员工ID</span><input type="text" name="wiID" class=" form-control formText" id="firstname"" placeholder="请录入会议类型"></div>
  <div><span class="titlespan">操作管理员</span><input type="text" name="admID" class="form-control formText" placeholder="请录入会议时间"></div>
  <div><span class="titlespan">员工姓名</span><input type="text" name="wiName" class="form-control formText" placeholder="请录入会议地址"></div>
    <div><span class="titlespan">员工性别:</span>
  男<input type="radio" name="wiSex" value="男">
  女<input type="radio" name="wiSex" value="女">
  </div>
  <div><span class="titlespan">员工年龄</span><input type="text" name="wiGrade" class="form-control formText" placeholder="请录入名称"></div>
  <div><span class="titlespan">员工密码</span><input type="text" name="wiPsd" class="form-control formText" placeholder="请录入会议发布人"></div>
   <div><span class="titlespan">员工部门</span><input type="text" name="wiAddress" class=" form-control formText" placeholder="请录入会议类型"></div>
  <div><span class="titlespan">员工电话</span><input type="text" name="wiPhone" class="form-control formText" placeholder="请录入会议时间"></div>
  <div><span class="titlespan">出生日期</span><input type="text" name="wiBorthday" class="form-control formText" placeholder="请录入会议地址"></div>
  <div><span class="titlespan"></span><input type="hidden" name="option" class="formText" value="addUserInfo"></div>
  <div style="margin-left:-17%"><span class="submitspan"></span><input type="submit" name="option" class="formSubmit" value="addUserInfo"></div> 
