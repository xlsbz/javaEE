...
<body>
		<div class="zjxxbox">
			...
			<form action=ApplyinformationS method="post"> 
				<h1 align="center">修改报名信息</h1>
				<div class="list">
					<p class="type">您的账号</p>
					<input type="text" placeholder="建议不要修改账号" name="contId"/>
				</div>
				<div class="list">
					<p class="type">您的姓名</p>
					<input type="text" placeholder="禁止修改姓名" name="contName"/>
				</div>
				<div class="list">
					<p class="type">您的性别</p>
				...
				<div class="btns">
				<input type="submit" name="option"  value="updateApplyinformation" class="ui-btn"></input>
				</div>
