...
<body>
 ...
 <p>请输入您的会议编号</p>
  <div>编号:<input type="text" name="admId" class="formText" }></div>
     ...
     <input type="submit" class="formSubmit" value="getbyId">
			...
			<div class="mod_box">
				<div class="m_tit">
					<h2 class="long"><a href="show.html">我的会议</a></h2>
				</div>
				<div class="m_cont">
					
				<ul class="mc_text">
					<c:forEach items="${meetings}" var="meetings">	
      				<li><a href="home/meet/signmeet.jsp">${meetings.mName}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;发布部门：${meetings.mAddress}</a></li>
       				 </c:forEach>
				</ul>
				</div>
			</div>
